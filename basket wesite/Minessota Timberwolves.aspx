<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="Minessota Timberwolves.aspx.cs" Inherits="MinssotaTimberwolves" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <h1>MINESSOTA TIMBERWOLVES</h1>
    <div class="sidebar">
   ...
   <asp:GridView ID="GridView2" CssClass="grid-viewCoach" OnRowCreated="gvHover_RowCreated" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" ShowHeader="True" HorizontalAlign="Left">
    ...
    <asp:GridView ID="GridView3" runat="server" CssClass="grid-viewCoach" OnRowCreated="gvHover_RowCreated" AutoGenerateColumns="False" DataSourceID="SqlDataSource3">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BasketballCstr %>" SelectCommand="SELECT ID, NO, SURNAME, FIRSTNAME, POSITION, HEIGHT, BORN, NATIONALITY, COACH_FIRST_NAME + ' ' + COACH AS COACH, LOGO, PLAYER_IMAGE, COUNTRY_IMAGE FROM View_MINESSOTA_TIMBERWOLVES">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:BasketballCstr %>" SelectCommand="SELECT DISTINCT ARENA, ARENA_IMAGE FROM View_MINESSOTA_TIMBERWOLVES"></asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:BasketballCstr %>" SelectCommand="SELECT DISTINCT COACH_FIRST_NAME + ' ' + COACH AS COACH, COACH_IMAGE, COACH_FIRST_NAME FROM View_MINESSOTA_TIMBERWOLVES"></asp:SqlDataSource>
