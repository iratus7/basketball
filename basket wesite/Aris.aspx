<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.master" AutoEventWireup="true" CodeFile="Aris.aspx.cs" Inherits="Aris" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" CssClass="grid-viewPlayers" OnRowCreated="gvHover_RowCreated" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderWidth="1px" CellPadding="3" DataSourceID="SqlDataSource1" GridLines="Vertical" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
   ...
   <asp:GridView ID="GridView2" CssClass="grid-viewCoach" OnRowCreated="gvHover_RowCreated" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" ShowHeader="True" HorizontalAlign="Left">
    ...
    <asp:GridView ID="GridView3" runat="server" CssClass="grid-viewCoach" OnRowCreated="gvHover_RowCreated" AutoGenerateColumns="False" DataSourceID="SqlDataSource3">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BasketballCstr %>" SelectCommand="SELECT ID, NO, SURNAME, FIRSTNAME, POSITION, HEIGHT, BORN, NATIONALITY, COACH_FIRST_NAME + ' ' + COACH AS COACH, LOGO, PLAYER_IMAGE, COUNTRY_IMAGE FROM View_ARIS">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:BasketballCstr %>" SelectCommand="SELECT DISTINCT ARENA, ARENA_IMAGE FROM View_ARIS"></asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:BasketballCstr %>" SelectCommand="SELECT DISTINCT COACH_FIRST_NAME + ' ' + COACH AS COACH, COACH_IMAGE, COACH_FIRST_NAME FROM View_ARIS"></asp:SqlDataSource>
